...
public interface IEmployeeRepository
{
    ...
    Task<long> SaveAsync(long actorUserId, SaveEmployeeRequestDto request, CancellationToken cancellationToken = default);
}
...
public interface IEmployeeService
{
    ...
    Task<EmployeeDto?> GetByIdAsync(long userId, CancellationToken cancellationToken = default);
    Task<EmployeeDto?> SaveAsync(long actorUserId, SaveEmployeeRequestDto request, CancellationToken cancellationToken = default);
}
