...
public interface IOrganizationRepository
{
    ...
    Task<IReadOnlyList<OrganizationDocumentOptionDto>> GetDocumentsByBusinessCategoryAsync(int businessCategoryId, long underOrgId, CancellationToken cancellationToken = default);
